...
static void tianma_panel_init(struct tianma *ctx)
{
	...
	tianma_dcs_write_seq_static(ctx, 0xBD, 0x01); /* CABC parameters */
	...
	tianma_dcs_write_seq_static(ctx, 0xBD, 0x03);
	tianma_dcs_write_seq_static(ctx, 0xE4, 0x8E,0x98,0xA2,0xAD,0xB7,0xC1,0xCB,0xE0,0xEF,0xFF,0xFF,0x03,0xFF,0x13,0x28,0x3C,0x51,0x65,0x6F,0x8E,0xAD,0xFE,0xFF,0x03,0xAD,0xC1,0xD6,0xEA,0xFF,0x13,0x32,0x7A,0xAD,0xAA,0xFE,0x03);
	usleep_range(5 * 1000, 5 * 1010);
	tianma_dcs_write_seq_static(ctx, 0xBD, 0x00);
...
#endif
	connector->display_info.width_mm = 150;  // 149.616
	connector->display_info.height_mm = 249; // 249.36
