...
#include "imx355_ana_gain_table_22047.h"
#include "imx355mipiraw_Sensor_22047.h"
...
#define PFX "IMX355_camera_sensor_22047"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX355_SENSOR_ID_22047,
...
static void custom6_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
    ...
    imx355_table_write_cmos_sensor(ctx, custom6_setting_array,
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX355_SENSOR_ID_22047) && (data_length == CALI_DATA_SLAVE_LENGTH)
	    ...
	    } else if ((pStereodata->uSensorId == IMX355_SENSOR_ID_22047) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX355_AESYNC_START_ADDR_22047)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+1),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+2),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+3),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+4),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+5),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+6),
                    read_cmos_eeprom_8(ctx, IMX355_AESYNC_START_ADDR_22047+7));
...
{
    kal_uint16 idx = 0;
    read_imx355_eeprom_info_22047(ctx, EEPROM_META_MODULE_ID,
                &(imx355_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx355_common_data[1] << 8) |
                   imx355_common_data[0];
    read_imx355_eeprom_info_22047(ctx, EEPROM_META_SENSOR_ID,
                &(imx355_common_data[2]), 2);
    read_imx355_eeprom_info_22047(ctx, EEPROM_META_LENS_ID,
                &(imx355_common_data[4]), 2);
    read_imx355_eeprom_info_22047(ctx, EEPROM_META_VCM_ID,
                &(imx355_common_data[6]), 2);
    read_imx355_eeprom_info_22047(ctx, EEPROM_META_MODULE_SN,
...
static int open(struct subdrv_ctx *ctx)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            ...
            if (sensor_id == IMX355_SENSOR_ID_22047) {
                LOG_INF("i2c write id: 0x%x, sensor id: 0x%x\n", ctx->i2c_write_id, sensor_id);
                break;
            }
            LOG_INF("Read sensor id fail, id: 0x%x\n", ctx->i2c_write_id);
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx355_ana_gain_table_22047);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx355_ana_gain_table_22047,
            sizeof(imx355_ana_gain_table_22047));
        }
        break;
...
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        imx355_read_eeprom_22047(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
    ...
    case SENSOR_FEATURE_GET_PDAF_DATA:
        ...
        imx355_read_DCC_22047(ctx, (kal_uint16) (*feature_data),
...
const struct subdrv_entry imx355_mipi_raw_22047_entry = {
    .name = "imx355_mipi_raw_22047",
    .id = IMX355_SENSOR_ID_22047,
    .pw_seq = pw_seq,
