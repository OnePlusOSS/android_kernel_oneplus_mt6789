...
#include "imx709_ana_gain_table_22047.h"
#include "imx709_eeprom_22047.h"
#include "imx709_vcm_22047.h"
...
#define PFX "imx709_camera_sensor_22047"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX709_SENSOR_ID_22047,
    ...
    .normal_video = { /* reg_C4-3-14 3264*1856@30fps*/
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 2448,
        .startx = 0,
...
{
    kal_uint16 idx = 0;
    read_imx709_eeprom_info_22047(ctx, EEPROM_META_MODULE_ID,
                &(imx709_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx709_common_data[1] << 8) |
                   imx709_common_data[0];
    read_imx709_eeprom_info_22047(ctx, EEPROM_META_SENSOR_ID,
                &(imx709_common_data[2]), 2);
    read_imx709_eeprom_info_22047(ctx, EEPROM_META_LENS_ID,
                &(imx709_common_data[4]), 2);
    read_imx709_eeprom_info_22047(ctx, EEPROM_META_VCM_ID,
                &(imx709_common_data[6]), 2);
    read_imx709_eeprom_info_22047(ctx, EEPROM_META_MODULE_SN,
                &(imx709_common_data[8]), 17);
    read_imx709_eeprom_info_22047(ctx, EEPROM_META_AF_CODE,
            ...
            if (*sensor_id == IMX709_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(first_read){
                    ...
                    read_imx709_LRC_22047(ctx, imx709_LRC_setting);
                    read_imx709_QSC_22047(ctx, imx709_QSC_setting);
...
static int open(struct subdrv_ctx *ctx)
{
    ...
    if (ctx->is_esd_enable == true) {
        ...
        write_imx709_vcm_22047_init(ctx);
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx709_ana_gain_table_22047);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx709_ana_gain_table_22047,
            sizeof(imx709_ana_gain_table_22047));
        }
        break;
...
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        read_imx709_eeprom_22047(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
    ...
    case SENSOR_FEATURE_GET_CUST_PIXEL_RATE:
    {
        switch (*feature_data) {
            case SENSOR_SCENARIO_ID_CUSTOM6:
            *(MUINT32 *)(uintptr_t)(*(feature_data + 1))
                = 592800000; /* 312000000(clk)*2(pixel)*0.95 */
            break;
            default:
            break;
        }
...
const struct subdrv_entry imx709_mipi_raw_22047_entry = {
    .name = "imx709_mipi_raw_22047",
    .id = IMX709_SENSOR_ID_22047,
    .pw_seq = pw_seq,
