...
#include "imx709telemipiraw_Sensor_22047.h"
#include "imx709tele_ana_gain_table_22047.h"
#include "imx709tele_eeprom_22047.h"
#include "imx709tele_vcm_22047.h"
...
#define PFX "imx709tele_camera_sensor_22047"
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX709TELE_SENSOR_ID_22047,
    ...
    .custom11 = {  //reg_N-4 3264x2448 @24FPS w/ PD
        .pclk = 864000000,
        .linelength = 11760,
        .framelength = 3056,
        .startx = 0,
...
{
    kal_uint16 idx = 0;
    read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_MODULE_ID,
                &(imx709tele_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx709tele_common_data[1] << 8) |
                   imx709tele_common_data[0];
    read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_SENSOR_ID,
                &(imx709tele_common_data[2]), 2);
    read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_LENS_ID,
                &(imx709tele_common_data[4]), 2);
    read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_VCM_ID,
                &(imx709tele_common_data[6]), 2);
    read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_MODULE_SN,
                &(imx709tele_common_data[8]), 17);
    read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_AF_CODE,
                &(imx709tele_common_data[25]), 6);
    qsc_is_valid = read_cmos_eeprom_8(ctx, 0x1F18);
    lrc_is_valid = read_cmos_eeprom_8(ctx, 0x2104);
    for (idx = 0; idx < 30; idx = idx + 4)
        LOG_INF("In %s: cam data: %02x %02x %02x %02x\n", __func__,
               imx709tele_common_data[idx], imx709tele_common_data[idx + 1],
               imx709tele_common_data[idx + 2],
...
static kal_uint16 imx709tele_preview_setting[] = {
//4Lane
//reg_N-2
...
static kal_uint16 imx709tele_capture_setting[] = {
...
static kal_uint16 imx709tele_custom6_setting[] = {
    //MIPI output setting
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
...
static kal_uint16 imx709tele_custom7_setting[] = {
...
static kal_uint16 imx709tele_custom9_setting[] = {
...
static kal_uint16 imx709tele_custom10_setting[] = {
    0x0112, 0x0A,
    0x0113, 0x0A,
    0x0114, 0x03,
    0x0342, 0x16,
...
{
	kal_int32 ret = ERROR_NONE;
	kal_uint16 reg = IMX709TELE_EEPROM_LOCK_REGISTER_22047;
	if (enable) {
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == IMX709TELE_SENSOR_ID_22047) && (data_length == CALI_DATA_SLAVE_LENGTH)
			&& (data_base == IMX709TELE_STEREO_START_ADDR_22047)) {
			...
			write_eeprom_protect(ctx, 1);
			msleep(6);
			LOG_INF("com_0:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_22047));
			LOG_INF("com_39:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_22047+39));
			LOG_INF("innal_40:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_22047+40));
			LOG_INF("innal_1556:0x%x\n", read_cmos_eeprom_8(ctx, IMX709TELE_STEREO_START_ADDR_22047+1544));
			LOG_INF("write_Module_data Write end\n");
		} else if ((pStereodata->uSensorId == IMX709TELE_SENSOR_ID_22047) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX709TELE_AESYNC_START_ADDR_22047)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+1),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+2),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+3),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+4),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+5),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+6),
                    read_cmos_eeprom_8(ctx, IMX709TELE_AESYNC_START_ADDR_22047+7));
            ...
            if (*sensor_id == IMX709_SENSOR_ID) {
                *sensor_id = imgsensor_info.sensor_id;
                ...
                if(first_read){
                    ...
                    read_imx709tele_LRC_22047(ctx, imx709tele_LRC_setting);
                    read_imx709tele_QSC_22047(ctx, imx709tele_QSC_setting);
...
static int open(struct subdrv_ctx *ctx)
{
    ...
    if (ctx->is_esd_enable == true) {
        ...
        write_imx709tele_vcm_22047_init(ctx);
                 ...
                 UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx709tele_ana_gain_table_22047);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx709tele_ana_gain_table_22047,
            sizeof(imx709tele_ana_gain_table_22047));
        }
        break;
    ...
    *feature_para_len = 4;
    ...
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        default:
            read_imx709tele_eeprom_info_22047(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
...
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        read_imx709tele_eeprom_22047(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
...
*/
const struct subdrv_entry imx709tele_mipi_raw_22047_entry = {
    .name = "imx709tele_mipi_raw_22047",
    .id = IMX709TELE_SENSOR_ID_22047,
    .pw_seq = pw_seq,
