...
#include "imx890_ana_gain_table_22047.h"
#include "imx890_Sensor_setting_22047.h"
...
#define PFX "IMX890_camera_sensor_22047"
...
static kal_uint16 read_cmos_eeprom_8(struct subdrv_ctx *ctx, kal_uint16 addr)
{
    ...
    adaptor_i2c_rd_u8(ctx->i2c_client, IMX890_EEPROM_READ_ID_22047 >> 1, addr, (u8 *)&get_byte);
    return get_byte;
}
                   ...
                   BYTE *data, int size)
{
    ...
    if (adaptor_i2c_rd_p8(ctx->i2c_client, IMX890_EEPROM_READ_ID_22047 >> 1,
                addr, data, size) < 0) {
        return false;
    }
    return true;
        ...
        kal_uint16 addr, kal_uint8 *para, kal_uint32 len)
{
    ...
    ret = adaptor_i2c_wr_p8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_22047 >> 1,
            addr, para, len);
...
{
    kal_int32 ret = ERROR_NONE;
    kal_uint16 reg = IMX890_EEPROM_LOCK_REGISTER_22047;
    if (enable) {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_22047 >> 1,
            reg, (IMX890_EEPROM_WRITE_ID_22047 & 0xFE) | 0x01);
    }
    else {
        adaptor_i2c_wr_u8(ctx->i2c_client, IMX890_EEPROM_WRITE_ID_22047 >> 1,
            reg, IMX890_EEPROM_WRITE_ID_22047 & 0xFE);
    }
...
static kal_int32 eeprom_table_write_22047(struct subdrv_ctx *ctx, kal_uint16 data_base, kal_uint8 *pData, kal_uint16 data_length) {
...
static kal_int32 eeprom_64align_write_22047(struct subdrv_ctx *ctx, kal_uint16 data_base, kal_uint8 *pData, kal_uint16 data_length) {
	...
	if (part1_length) {
		ret = eeprom_table_write_22047(ctx, data_base, pData, part1_length);
		if (ret == -1) {
			/* open write protect */
	...
	msleep(6);
	if (part2_length) {
		ret = eeprom_table_write_22047(ctx, addr_64align, pData + part1_length, part2_length);
		if (ret == -1) {
			/* open write protect */
			write_eeprom_protect(ctx, 1);
            ...
            ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
    ...
    if(pStereodata != NULL) {
        ...
        if ((pStereodata->uSensorId == IMX890_SENSOR_ID_22047) && (data_length == CALI_DATA_MASTER_LENGTH)
            && (data_base == IMX890_STEREO_MT_START_ADDR_22047 || data_base == IMX890_STEREO_MW_START_ADDR_22047)) {
            LOG_INF("Write: %x %x %x %x\n", pData[0], pData[39], pData[40], pData[1556]);

            eeprom_64align_write_22047(ctx, data_base, pData, data_length);
        ...
        } else if ((pStereodata->uSensorId == IMX890_SENSOR_ID_22047) && (data_length < AESYNC_DATA_LENGTH_TOTAL)
            && (data_base == IMX890_AESYNC_START_ADDR_22047)) {
            ...
            LOG_INF("readback main aesync: %x %x %x %x %x %x %x %x\n",
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+1),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+2),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+3),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+4),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+5),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+6),
                    read_cmos_eeprom_8(ctx, IMX890_AESYNC_START_ADDR_22047+7));
...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = IMX890_SENSOR_ID_22047,
    ...
    .custom10 = { //reg_G QBin(VBin) V2H2 2048x1536 @24fps w/ PD
        .pclk = 1300800000,
        .linelength = 26448,
        .framelength = 2024,
        .startx = 0,
...
static struct SENSOR_VC_INFO2_STRUCT SENSOR_VC_INFO2[] = {
    ...
    },
    {
        ...
        {
            {VC_STAGGER_NE, 0x00, 0x2b, 2048, 1536},
            {VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 2048, 384},
        },
        1
    },
    {
...
#define QSC_IS_VALID_ADDR 0x1D51
...
{
    kal_uint16 idx = 0;
    read_imx890_eeprom_info_22047(ctx, EEPROM_META_MODULE_ID,
                &(imx890_common_data[0]), 2);
    imgsensor_info.module_id = (kal_uint16)(imx890_common_data[1] << 8) |
                   imx890_common_data[0];
    read_imx890_eeprom_info_22047(ctx, EEPROM_META_SENSOR_ID,
                &(imx890_common_data[2]), 2);
    read_imx890_eeprom_info_22047(ctx, EEPROM_META_LENS_ID,
                &(imx890_common_data[4]), 2);
    read_imx890_eeprom_info_22047(ctx, EEPROM_META_VCM_ID,
                &(imx890_common_data[6]), 2);
    read_imx890_eeprom_info_22047(ctx, EEPROM_META_MODULE_SN,
                &(imx890_common_data[8]), 17);
    read_imx890_eeprom_info_22047(ctx, EEPROM_META_AF_CODE,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    if (sensor_id == IMX890_SENSOR_ID) {
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_init_otp_setting_22047,
            sizeof(imx890_init_otp_setting_22047)/sizeof(kal_uint16));
        LOG_INF("write 890 OTP -\n");
    }
    imx890_table_write_cmos_sensor_8(ctx, imx890_init_setting_22047,
        sizeof(imx890_init_setting_22047)/sizeof(kal_uint16));
...
{
    LOG_INF("E\n");
    imx890_table_write_cmos_sensor_8(ctx, imx890_custom11_setting,
        sizeof(imx890_custom11_setting)/sizeof(kal_uint16));
    set_mirror_flip(ctx, ctx->mirror);
    if (otp_flag == OTP_QSC_NONE) {
        LOG_INF("OTP no QSC Data, close qsc register");
        write_cmos_sensor_8(ctx, 0x32D2, 0x00);
...
unsigned short imx890_seamless_preview_Optimize1_22047[] = {
    0x38B0,0x00,
    0x38B1,0x00,
    0x38B2,0x00,
    0x38B3,0x00,
...
unsigned short imx890_seamless_custom5_Optimize1_22047[] = {
    0x38B0,0x00,
    0x38B1,0x86,
    0x38B2,0x00,
    0x38B3,0x86,
        ...
        enum SENSOR_SCENARIO_ID_ENUM scenario_id, uint32_t *ae_ctrl)
{
    ...
    case SENSOR_SCENARIO_ID_CUSTOM5:
    {
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_custom5_22047,
                sizeof(imx890_seamless_custom5_22047) / sizeof(kal_uint16));
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_custom5_Optimize1_22047, sizeof(imx890_seamless_custom5_Optimize1_22047)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
    case SENSOR_SCENARIO_ID_NORMAL_PREVIEW:
    {
        ...
        FMC_GPH_START;
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_normal_preview_22047,
                 sizeof(imx890_seamless_normal_preview_22047) / sizeof(kal_uint16));
        ...
        imx890_table_write_cmos_sensor_8(ctx, imx890_seamless_preview_Optimize1_22047, sizeof(imx890_seamless_preview_Optimize1_22047)/sizeof(kal_uint16));
        FMC_GPH_END;
    }
        break;
                ...
                UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
        if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
            *(feature_data + 0) =
                sizeof(imx890_ana_gain_table_22047);
        } else {
            memcpy((void *)(uintptr_t) (*(feature_data + 1)),
            (void *)imx890_ana_gain_table_22047,
            sizeof(imx890_ana_gain_table_22047));
        }
        break;
    ...
    case SENSOR_FEATURE_GET_EEPROM_STEREODATA:
        ...
        case EEPROM_STEREODATA_MT_MAIN:
            read_imx890_eeprom_info_22047(ctx, EEPROM_META_STEREO_MT_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        case EEPROM_STEREODATA_MW_MAIN:
        default:
            read_imx890_eeprom_info_22047(ctx, EEPROM_META_STEREO_MW_MAIN_DATA,
                    (BYTE *)feature_return_para_32, *feature_para_len);
            break;
        }
        break;
#define EEPROM_8k 0x8000
    case SENSOR_FEATURE_GET_SENSOR_OTP_ALL:
        ...
        read_imx890_eeprom_22047(ctx, 0x00, (BYTE *)feature_return_para_32, *feature_para_len);
    break;
...
const struct subdrv_entry imx890_mipi_raw_22047_entry = {
    .name = "imx890_mipi_raw_22047",
    .id = IMX890_SENSOR_ID_22047,
    .pw_seq = pw_seq,
